macro "Delete Inside Selection Area" {
    ...
    //setTool("rectangle");
    setTool("freehand");
    //showMessage("Action required", "Draw Area in which points should be DELETED in, \npress 't' to add to ROI Manager, which will continue script");
    print("!-- Draw Area in which points should be DELETED in.");
   ...
   // Poll until the ROI Manager has at least one ROI.
    ...
    print("--- Deleted "+deletioncount+") points inside selected area.");
}
